import { a as SIZE_UNITS, t as transformGenomicRangeArcToStandard, b as transformGenomicRangeToStandard, S as SpecificationProcessor } from './specification-processor-d89a6709.js';
...
class DataProcessor {
  ...
  getClosestPoint(point) {
    let pointToReturn =
      this.data[this.index.neighbors(point[0], point[1], 0.5, 0.5)];
    let distance = 0;
    let isInside = true;
