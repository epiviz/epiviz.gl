...
*/
const $2a4f8c7882dfdea78821148c89bf8779$export$transformGenomicRangeToStandard = (mark, xScale, yScale) => {
  let x, y, width, height;
  if (Array.isArray(mark.x)) {
    let x1 = xScale(mark.x[0]);
    x = mark.x[0];
    width = (xScale(mark.x[1]) - x1) / $2a4f8c7882dfdea78821148c89bf8779$export$SIZE_UNITS;
  } else {
    x = mark.x;
    width = mark.width;
  }
  if (Array.isArray(mark.y)) {
    ...
    y = mark.y[0];
    height = (yScale(mark.y[1]) - y1) / $2a4f8c7882dfdea78821148c89bf8779$export$SIZE_UNITS;
  } else {
    y = mark.y;
    height = mark.height;
  }
...
*/
const $2a4f8c7882dfdea78821148c89bf8779$export$transformGenomicRangeArcToStandard = (mark, xScale, yScale) => {
  let x, y, width, height;
  if (Array.isArray(mark.x)) {
    ...
    width = Math.abs(xScale(x2) - x1ClipSpace) / $2a4f8c7882dfdea78821148c89bf8779$export$SIZE_UNITS;
  } else {
    x = mark.x;
    width = mark.width;
  }
  if (Array.isArray(mark.y)) {
    ...
    height = Math.abs(yScale(y2) - y1ClipSpace) / $2a4f8c7882dfdea78821148c89bf8779$export$SIZE_UNITS;
  } else {
    y = mark.y;
    height = mark.height;
  }
...
class $2a4f8c7882dfdea78821148c89bf8779$export$default {
  ...
  */
  calculateForMark(mark) {
    if (this.track.x.type === "genomicRange" || this.track.y.type === "genomicRange") {
      if (this.track.mark === "arc") {
        return this._calculateForMark($2a4f8c7882dfdea78821148c89bf8779$export$transformGenomicRangeArcToStandard(mark, this.xScale, this.yScale));
      }
      return this._calculateForMark($2a4f8c7882dfdea78821148c89bf8779$export$transformGenomicRangeToStandard(mark, this.xScale, this.yScale));
    }
  ...
  _getVerticesForTick(mark) {
    ...
    // 1----2
    if (this.track.width) {
      return [center[0], center[1], center[0] + mark.width * $2a4f8c7882dfdea78821148c89bf8779$export$SIZE_UNITS, center[1]];
    }
    // 1
    // |
    // 2
    if (mark.height) {
      ...
      return [center[0], center[1], center[0], center[1] + mark.height * $2a4f8c7882dfdea78821148c89bf8779$export$SIZE_UNITS];
    }
  }
}
...
$parcel$export($2a4f8c7882dfdea78821148c89bf8779$exports, "transformGenomicRangeToStandard", function () {
  return $2a4f8c7882dfdea78821148c89bf8779$export$transformGenomicRangeToStandard;
});
$parcel$export($2a4f8c7882dfdea78821148c89bf8779$exports, "transformGenomicRangeArcToStandard", function () {
  return $2a4f8c7882dfdea78821148c89bf8779$export$transformGenomicRangeArcToStandard;
});
  ...
  */
  processHeadersAndMappers() {
    ...
    if (this.isInlineData) {
      ...
      this.data.length = this.data[this.headers[0]].length;
      // assign length to data object for iteration
      this.index = 0;
    } else {
