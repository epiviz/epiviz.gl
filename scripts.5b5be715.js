...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"w7rT":[function(require,module,exports) {
/*!
...
},{"supercluster":"Ot57","@turf/boolean-point-in-polygon":"Ae2a","@turf/helpers":"tCNg"}],"DFiv":[function(require,module,exports) {
"use strict";
...
},{}],"bgG2":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  _createClass(MouseReader, [{
    ...
    value: function init() {
      ...
      this.element.addEventListener("mousemove", function (event) {
        ...
        switch (_this.toolbar.mouseAction) {
          ...
          case "lasso":
            (_this$_currentSelecti = _this._currentSelectionPoints).push.apply(_this$_currentSelecti, _toConsumableArray(_this._calculateViewportSpot(event.layerX, event.layerY)));
      ...
      this.element.addEventListener("mouseup", function (event) {
        ...
        switch (_this.toolbar.mouseAction) {
          ...
          case "lasso":
            if (_this._currentSelectionPoints.length < 6) {
              _this._currentSelectionPoints = [];
    ...
    key: "_updateLassoSelectView",
    value: function _updateLassoSelectView() {
      ...
      for (var i = 0; i < this._currentSelectionPoints.length; i += 2) {
        var asCanvasPoint = this._calculateViewportSpotInverse(this._currentSelectionPoints[i], this._currentSelectionPoints[i + 1]);

        pointAttr += "".concat(asCanvasPoint[0], ", ").concat(asCanvasPoint[1], " ");
      }
...
exports.default = _default;
},{"./utilities":"DFiv"}],"i8fG":[function(require,module,exports) {
"use strict";
...
},{"./../utils":"S1cf","./../core/settle":"aS8y","./../helpers/cookies":"dn2M","./../helpers/buildURL":"H6Qo","../core/buildFullPath":"Kxk+","./../helpers/parseHeaders":"ZeD7","./../helpers/isURLSameOrigin":"/w7L","../core/createError":"3bIi"}],"pBGv":[function(require,module,exports) {
...
},{"./lib/axios":"nUiQ"}],"/ubv":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"fpsmeter":"w7rT","./data-processor":"oP6w","./mouse-reader":"bgG2","./toolbar":"i8fG","axios":"dZBD"}],"lwLj":[function(require,module,exports) {
"use strict";
...
function (_Handler) {
  ...
  function OffscreenHandler() {
    ...
    _this.mouseReader = new _mouseReader.default(document.createElement("div"), _this.toolbar, _this.handleMessage.bind(_assertThisInitialized(_this))); // Ensure div is directly on top of canvas

    _this.canvas.style.position = "absolute";
    _this.mouseReader.element.id = "mouse-reader";
    return _this;
  }

  _createClass(OffscreenHandler, [{
    key: "addToDOM",
    value: function addToDOM(worker, dataWorker) {
      var _this2 = this;

      this.content.appendChild(this.canvas);
      this.content.appendChild(this.mouseReader.element); // Reinit controls with new mouse reader
      ...
      }, this.mouseReader.getViewport()), [this.offscreenCanvas]);
...
exports.default = _default;
},{"./handler":"/ubv","./mouse-reader":"bgG2"}],"G3/0":[function(require,module,exports) {
module.exports = "data/tsne.csv";
},{}],"Jlas":[function(require,module,exports) {
module.exports = "data/tsne_tenth.csv";
},{}],"lgZ8":[function(require,module,exports) {
module.exports = "data/tsne_hundreth.csv";
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  handler.addToDOM(new Worker("offscreen-webgl-worker.1e800b4b.js"), new Worker("data-processor-worker.59c62e30.js"));
  handler.forceDrawerRender();
});
},{"./offscreen-handler":"lwLj","../data/tsne.csv":"G3/0","../data/tsne_tenth.csv":"Jlas","../data/tsne_hundreth.csv":"lgZ8","./offscreen-webgl-worker.js":[["offscreen-webgl-worker.1e800b4b.js","HYUx"],"offscreen-webgl-worker.1e800b4b.js.map","HYUx"],"./data-processor-worker.js":[["data-processor-worker.59c62e30.js","Vmom"],"data-processor-worker.59c62e30.js.map","Vmom"]}]},{},["g2Hq"], null)
//# sourceMappingURL=scripts.5b5be715.js.map